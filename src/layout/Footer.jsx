...
function Footer() {
  return (
    <footer className="footer footer-center p-10 bg-background text-text text-primary-content">
  ...
  <nav>
    <div className="grid grid-flow-col gap-4  text-text cursor-pointer">
